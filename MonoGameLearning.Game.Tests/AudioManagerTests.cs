...
public class AudioManagerTests
{
    ...
    {
        Assert.That(AudioManager.ComputeMusicVolume(0.8f, true), Is.EqualTo(0.24f).Within(1e-6f));
    }

    [Test]
    public void ComputeMusicVolume_Unpaused_ReturnsBase()
    {
        Assert.That(AudioManager.ComputeMusicVolume(0.8f, false), Is.EqualTo(0.8f));
    }

    [Test]
    public void ComputeMusicVolume_ZeroBase_StaysZero()
    {
        Assert.That(AudioManager.ComputeMusicVolume(0f, true), Is.EqualTo(0f));
        Assert.That(AudioManager.ComputeMusicVolume(0f, false), Is.EqualTo(0f));
    }
