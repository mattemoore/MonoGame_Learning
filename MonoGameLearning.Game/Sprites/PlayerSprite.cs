...
public static class PlayerSprite
{
    public static AnimatedSprite GetPlayerSprite(ContentManager content)
    {
        ...
        spriteSheet.DefineAnimation("idle", builder => builder
            .IsLooping(true)
            .AddFrame("adventurer-idle-00", TimeSpan.FromSeconds(0.1))
        ...
        spriteSheet.DefineAnimation("attack1", builder => builder
            .IsLooping(false)
        ...
        spriteSheet.DefineAnimation("attack2", builder => builder
            .IsLooping(false)
        ...
        spriteSheet.DefineAnimation("attack3", builder => builder
            .IsLooping(false)
        ...
        spriteSheet.DefineAnimation("run", builder => builder
            .IsLooping(true)
