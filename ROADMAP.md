...
- [ ] **Throwable Weapons**: Add `ProjectileWeapon` items (e.g., knife, bottle) that the player throws forward in the facing direction with its own hitbox/hurtbox. [plan](<.kilo/plans/todo/1789329918665-throwable-weapons.md>)
